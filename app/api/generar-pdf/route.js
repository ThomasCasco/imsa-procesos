...
// Usamos puppeteer o puppeteer-core dependiendo del entorno
...
export async function POST(request) {
  ...
  try {
    console.log("Loading Chromium executable...");
    const isProduction = process.env.NODE_ENV === "production";
    const executablePath = isProduction ? await chromium.executablePath() : undefined;
